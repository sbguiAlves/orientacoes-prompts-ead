...
st.title("Múltipla Escolha Complexa")
st.divider()
st.markdown("""<h3 style="color: #5219A1"> Primeiro Prompt: Contextualize!</h3>""", unsafe_allow_html=True)
st.code(variaveis["intro_complexa"], language="None", wrap_lines=True)
st.markdown("""<h3 style="color: #5219A1">Segundo Prompt: Especifique, pela Taxonomia de Bloom!</h3>""", unsafe_allow_html=True)
